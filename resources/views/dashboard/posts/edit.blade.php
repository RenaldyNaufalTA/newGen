...
@section('content')
    <form class="w-full md:px-10 pt-5" id="myform" action="{{ route('mypost.update', $post->slug) }}" method="post"
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                ...
                <input
                    ...
                    name="title" id="title" type="text" placeholder="Input title" value="{{ $post->title }}"
                    required autofocus>
                @error('title')
        ...
        <div class="flex flex-wrap justify-center -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    name="slug" id="slug" type="text" placeholder="slug" required value="{{ $post->slug }}">
                @error('slug')
                    <p class="err-msg-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <x-forms.edit-upload-image :post="$post" :fileSize="$fileSize"></x-forms.edit-upload-image>
